...
vim.keymap.set('n', '<leader>tt', '<cmd>tab term<CR>', { desc = 'Open terminal' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>th', builtin.colorscheme, { desc = 'Find [TH]emes' })
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>e', MiniFiles.open, { desc = 'Focus file tree' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'cpp', 'make', 'haskell', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
  ...
  { 'micka-daoud/epiheader.nvim', lazy = false },
